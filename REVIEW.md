...
- - **Model portal sudah tersedia untuk konten publik**: terdapat `Announcement` (pengumuman) dan `FrequentlyAskedQuestion` (FAQ) lengkap dengan metadata publikasi dan pengurutan, sehingga portal siap menampilkan informasi umum.【F:backend/portal/models.py†L1-L44】
